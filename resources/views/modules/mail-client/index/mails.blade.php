        ...
        <table class="striped responsive-table">
            ...
            <tbody>
                ...
                <tr class="email-row" data-mailid={{ $message->getId() }}>
                    ...
                    <td class="tooltipped" @if(!$message->getIsRead()) font-weight: bold; @endif" data-position="bottom" data-tooltip="{{ $message->getBody()->getContent() }}">{{ $message->getBodyPreview() }}</td>
